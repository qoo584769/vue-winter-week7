  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content border-0">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-sm-4">
            <div class="mb-2">
              <div class="mb-3">
                ...
                <input
                  ...
                  class="form-control"
                  placeholder="請輸入圖片連結"
                  v-model="tempData.data.imageUrl"
                />
              </div>
            ...
            <div
              v-if="!tempData.data.imagesUrl || (tempData.data.imagesUrl.length === 0 && addStatus)"
            >
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" @click.prevent="submitBtn">確認</button>
      </div>
    </div>
  </div>
</template>
...
const props = defineProps(['tempData', 'addImg', 'delImg', 'submitBtn'])
const tempData = reactive(props.tempData)
</script>
